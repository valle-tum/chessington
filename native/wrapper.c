...
godot_variant _camera_get_image_greyscale(godot_object* p_instance, void* p_method_data, void* p_user_data, int p_num_args, godot_variant** p_args);
godot_variant _camera_get_image_pixelstrip(godot_object* p_instance, void* p_method_data, void* p_user_data, int p_num_args, godot_variant** p_args);
...
godot_variant _camera_set_resolution(godot_object* p_instance, void* p_method_data, void* p_user_data, int p_num_args, godot_variant** p_args);
...
void GDN_EXPORT godot_nativescript_init(void *p_handle) {
    ...
    set_resolution.method = &_camera_set_resolution;
    nativescript_api->godot_nativescript_register_method(p_handle, "Camera", "set_resolution", attributes, set_resolution);
...
godot_variant _camera_get_image(godot_object *p_instance, void *p_method_data, void *p_user_data, int p_num_args, godot_variant **p_args) {
    ...
    int display_option = p_num_args > 0 ? api->godot_variant_as_int(p_args[0]) : DISPLAY_OPTION_RBG;

    writer = api->godot_pool_byte_array_write(&user_data->buffer);
    uint8_t* data = api->godot_pool_byte_array_write_access_ptr(writer);
    updated = camera_get_image(user_data->camera, data, &user_data->counter, display_option);
...
godot_variant _camera_set_threshold(godot_object* p_instance, void* p_method_data, void* p_user_data, int p_num_args, godot_variant** p_args) {
    ...
    camera_set_threshold(user_data->camera, value);
...
godot_variant _camera_set_resolution(godot_object* p_instance, void* p_method_data, void* p_user_data, int p_num_args, godot_variant** p_args) {
    ...
    if (p_num_args > 0) {
        width = api->godot_variant_as_int(p_args[0]);
    }

    if (p_num_args > 1) {
        height = api->godot_variant_as_int(p_args[1]);
    }

    camera_set_resolution(user_data->camera, width, height);
